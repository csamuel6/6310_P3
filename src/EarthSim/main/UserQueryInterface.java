...
public class UserQueryInterface extends JFrame {
	...
	private JTextField lowerLatitude = new JTextField();
	...
	public UserQueryInterface() {
		...
		lowerLatitude = new JTextField();
		lowerLatitude.setBounds(217, 357, 166, 30);
		lowerLatitude.setToolTipText("Enter a upper longitude.");
		lowerLatitude.setFont(new Font("Arial", Font.PLAIN, 20));
		...
		contentPane.add(gcTableScrollPane);
		...
		btnRanQuery.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				queryParameters.setTimeStep(Integer.valueOf(simTimeStep
						.getText()));
				queryParameters.setLowerLatitude(Integer.valueOf(lowerLatitude.getText()));
				queryParameters.setUpperLatitude(Integer.valueOf(upperLatitude.getText()));
				queryParameters.setLowerLongitude(Integer.valueOf(lowerLongitude.getText()));
				queryParameters.setUpperLongitude(Integer.valueOf(upperLongitude.getText()));
